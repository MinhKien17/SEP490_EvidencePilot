...
@Tag(name = "Source Categories", description = "Source discipline taxonomy")
public class SourceCategoryController {
    ...
    public List<SourceCategoryResponse> adminCategories(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public SourceCategoryResponse create(
