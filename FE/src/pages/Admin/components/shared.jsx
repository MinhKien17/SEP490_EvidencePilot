...
const t = {
  en: {
    ...
    dismiss: 'Dismiss',
    maintenanceBannerMsg: 'Scheduled maintenance notice: the platform may be briefly unavailable. Save your work and log out before the maintenance window.',
  ...
  vi: {
    ...
    dismiss: 'Đóng',
    maintenanceBannerMsg: 'Thông báo bảo trì: hệ thống có thể tạm ngưng hoạt động. Hãy lưu công việc và đăng xuất trước khung bảo trì.',
