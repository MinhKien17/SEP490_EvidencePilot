...
const t = {
  en: {
    ...
    // UsersTab
    searchUsers: 'Search by email or name...', allRoles: 'All Roles', allStatuses: 'All Statuses',
    emailAddress: 'Email Address', userRole: 'User Role',
    banUser: 'Ban User', activateUser: 'Activate User', deleteUser: 'Delete User',
    adminRoleFixed: 'Admin role cannot be changed',
    changeRoleTo: 'Click to change role to',
  ...
  vi: {
    ...
    // UsersTab
    searchUsers: 'Tìm kiếm theo email hoặc tên...', allRoles: 'Tất cả vai trò', allStatuses: 'Tất cả trạng thái',
    ...
    adminRoleFixed: 'Không thể thay đổi vai trò Admin',
    changeRoleTo: 'Nhấp để đổi vai trò sang',
