  ...
  return (
    <div className="p-8 space-y-6 bg-[#f8fafc]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 pb-5">
        <div>
          <h1 className="text-3xl font-extrabold text-[#1e3a8a] tracking-tight">{lang.broadcast}</h1>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-3.5 border-t border-gray-150 bg-gray-50/50 text-xs font-semibold text-gray-500">
          <span>Showing {filteredHistory.length} of {displayHistory.length} broadcasts</span>
        </div>
      </div>
