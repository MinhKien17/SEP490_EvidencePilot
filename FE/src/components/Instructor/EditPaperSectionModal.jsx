                ...
                <div className="mx-auto max-w-4xl space-y-5">
                  ...
                  <div className="flex flex-wrap items-end gap-2 rounded-xl border border-slate-200 bg-slate-50 p-3">
                    {selectedSection.sectionType === 'REFERENCE' ? (
                      ...
                      <label className="min-w-[13rem] flex-1 text-xs font-semibold text-slate-600">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-indigo-100 bg-indigo-50/40 p-3">
                    <p className="text-xs font-bold text-indigo-900">{labels.standards}</p>
